...
- **Equipo:** 4 integrantes (ver [equipo](equipo.md))  
...
AppFlowy-Cloud es el backend self-hosted de **AppFlowy**, una alternativa open source a Notion enfocada en workspaces colaborativos para equipos y empresas. Permite a organizaciones tener pleno control sobre sus datos al alojar la solución en infraestructura propia.  
...
### Justificación de la selección (criterios de la ficha)
...
| GitHub Pages | Publicación de documentación y burndown chart |
...
Ver detalle en [cronograma](cronograma.md).  

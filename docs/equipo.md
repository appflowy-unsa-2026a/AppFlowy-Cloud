---
title: Equipo
eyebrow: Documentación · Personas
description: Integrantes del equipo, correos institucionales y rotación del liderazgo entre los cuatro Sprints.
permalink: /equipo/
---
...
<div class="team">
  <article class="member">
    <div class="member__avatar">JH</div>
  ...
  <article class="member">
    <div class="member__avatar">GM</div>
    <div class="member__body">
  ...
  <article class="member">
    <div class="member__avatar">JT</div>
    <div class="member__body">
  ...
  <article class="member">
    <div class="member__avatar">GQ</div>
    <div class="member__body">
...
<div class="callout callout--note">
  ...
  <div class="callout__body">
    <p>El equipo está conformado por cuatro integrantes. La ficha del proyecto sugiere grupos de cinco; la excepción fue consultada y aceptada por el docente.</p>
  </div>
</div>

## Rotación del liderazgo

El rol de líder del equipo es **rotativo por Sprint**, conforme a la metodología establecida en la ficha del proyecto. El líder coordina las tareas internas del grupo durante su Sprint asignado.

| Sprint | Período | Líder |
|:---|:---|:---|
| Sprint 0 | Planificación | Huaynacho Mango, Jerry Anderson |
| Sprint 1 | 17.MAY – 27.MAY.2026 | Mendoza Contreras, Giovani Angel |
| Sprint 2 | 28.MAY – 10.JUN.2026 | Ticona Saure, José María |
| Sprint 3 | 11.JUN – 26.JUN.2026 | Quispe Mamani, Gabriel |
| Sprint 4 | 27.JUN – 13.JUL.2026 | Huaynacho Mango, Jerry Anderson |

## Compromisos del equipo

- Cumplir las responsabilidades acordadas en cada Sprint.
- Mantener comunicación constante entre los integrantes.
- Documentar el avance en **GitHub Projects** y **GitHub Issues**.
- Practicar habilidades blandas: **liderazgo · responsabilidad · comunicación · asertividad**.
